defmodule PetalBoilerplateWeb.UserLiveTest do
  use PetalBoilerplateWeb.ConnCase

  import Phoenix.LiveViewTest
  import PetalBoilerplate.AccountsFixtures

  @create_attrs %{age: 42, avatar: "some avatar", blacklisted: true, country: "some country", dob: %{day: 7, month: 11, year: 2022}, firstname: "some firstname", gender: "some gender", lastname: "some lastname", privacy: true, status: true, username: "some username"}
  @update_attrs %{age: 43, avatar: "some updated avatar", blacklisted: false, country: "some updated country", dob: %{day: 8, month: 11, year: 2022}, firstname: "some updated firstname", gender: "some updated gender", lastname: "some updated lastname", privacy: false, status: false, username: "some updated username"}
  @invalid_attrs %{age: nil, avatar: nil, blacklisted: false, country: nil, dob: %{day: 30, month: 2, year: 2022}, firstname: nil, gender: nil, lastname: nil, privacy: false, status: false, username: nil}
